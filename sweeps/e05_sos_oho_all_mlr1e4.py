...
# e05 = e03 with full OHO target (β + lr + wd) and mlr bumped 10x to 1e-4.
# val_beta=0 (pure recon at val, same as e03). Inner inits: β=1, lr=1e-3, wd=1e-6.
SEEDS = [0, 1, 2, 3, 4]
...
task_name = (
    "E05_sos_oho_all_mlr1e4_test: 1-cell smoke"
    if args.test
    else "E05_sos_oho_all_mlr1e4: β+lr+wd OHO, mlr=1e-4, val_beta=0 x 5 seeds"
)
opt_task = Task.init(
...
optimizer = HyperParameterOptimizer(
    ...
    hyper_parameters=[
        ...
        # logging + scheduling (identical to e03/e04)
