...
opt_task = Task.init(
    project_name="temp",
    task_name="OHO Seed+ILR Sweep: Batch-4000,Epochs-1000,CIFAR10,GRU-128,SGD-SGD,BPTT-RTRL",
...
task = Task.get_task(project_name="temp", task_name="j8ln9btl")
...
optimizer = HyperParameterOptimizer(
    ...
    hyper_parameters=[
        ...
        DiscreteParameterRange("config/learners/1/learner/momentum1", values=[0.0001, 0.0]),
        DiscreteParameterRange(
