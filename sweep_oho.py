...
opt_task = Task.init(
    project_name="oho",
    task_name="Seed+ILR Sweep: Batch-100,Epochs-100,FashionMNIST,RNN-128,SGD-Adam,BPTT-RTRL",
)
...
optimizer = HyperParameterOptimizer(
    base_task_id="00733c864264482eabebbe2d62e09fa1",  # Use the actual task ID
    hyper_parameters=[
