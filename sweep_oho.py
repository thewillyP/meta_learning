...
opt_task = Task.init(
    project_name="oho",
    task_name="Seed+ILR Sweep: Batch-4000,Epochs-1000,CIFAR10,RNN-512,SGD-ADAM,BPTT-RTRL",
)
...
optimizer = HyperParameterOptimizer(
    base_task_id="81048c3d4eaa4eaab73fac2783754881",  # Use the actual task ID
    hyper_parameters=[
