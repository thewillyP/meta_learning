...
opt_task = Task.init(
    project_name="oho",
    task_name="Eigenvalue Demo: Batch-4000,Epochs-1000,CIFAR10,LSTM-128,SGD-SGD,BPTT-RTRL",
...
optimizer = HyperParameterOptimizer(
    ...
    hyper_parameters=[
        ...
        DiscreteParameterRange("config/learners/1/learner/momentum1", values=[0.5]),
