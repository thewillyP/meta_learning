...
opt_task = Task.init(
    project_name="oho",
    task_name="Seed+ILR Sweep: Batch-4800,Epochs-2000,MNIST,RNN-32,SGD-ADAM,BPTT-RTRL",
)
...
optimizer = HyperParameterOptimizer(
    base_task_id="49d4d6c4eae741bfa4f33dcc1f701a78",  # Use the actual task ID
    hyper_parameters=[
        ...
        DiscreteParameterRange("config/learners/1/learner/epsilon", values=[1.0e-1]),
        DiscreteParameterRange("config/learners/1/optimizer/learning_rate/value", values=[1.0e-3]),
        ...
        DiscreteParameterRange("config/num_base_epochs", values=[2000]),
        DiscreteParameterRange("config/data/0/num_examples_in_minibatch", values=[4800]),
        DiscreteParameterRange("config/data/1/num_examples_in_minibatch", values=[4800]),
