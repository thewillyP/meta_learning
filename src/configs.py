...
VAE_BETA_OHO = GodConfig(
    ...
    sample_generators=[
        ...
        SampleGeneratorConfig(
            ...
            reporter=PerSampleGridReporter(GridReporter(title="vae_interp", rows=2, cols=10)),
        ),
    ],
...
VAE_BASELINE = GodConfig(
    ...
    sample_generators=[
        ...
        SampleGeneratorConfig(
            ...
            seed=42,
            input=InterpolationSampleInput(pixel_transform="normalize"),
            reporter=PerSampleGridReporter(GridReporter(title="vae_interp_scan", rows=1, cols=10)),
        ),
    ],
    label_mask_value=-1e10,
    unlabeled_mask_value=-1e10,
