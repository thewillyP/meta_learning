...
PROJECT = "oho"
QUEUE = "willyp"
BASE_TASK_ID = "eee7cb236d4c47939feac947571f3156"  # VAE_BETA_OHO_V2_clip base (HardClip(1.0) baked in)
...
# logspace(1e-3, 1e0, 10) — wider range than E00 because clipping bounds gradient,
# so effective step ~ lr (not lr * grad_norm)
INNER_LR_VALUES = [
    1.0000000000e-03,
    2.1544346900e-03,
    4.6415888336e-03,
...
task_name = "E00b_test: 1-cell smoke" if args.test else "E00b: inner lr sweep WITH clipping (no OHO, fixed beta=1)"
opt_task = Task.init(
