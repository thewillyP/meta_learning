...
VAE_BETA_OHO = GodConfig(
    ...
    hyperparameters={
        "level0_sgd_lr": HyperparameterConfig(
            value=0.001,
            kind="learning_rate",
            count=1,
            hyperparameter_parametrization=HyperparameterConfig.identity(),
        ...
        "level0_sgd_wd": HyperparameterConfig(
            value=0.0,
            kind="weight_decay",
            count=1,
            hyperparameter_parametrization=HyperparameterConfig.identity(),
        ...
        "level0_sgd_momentum": HyperparameterConfig(
            value=0.0,
            kind="momentum",
            count=1,
            hyperparameter_parametrization=HyperparameterConfig.identity(),
        ...
        "level1_sgd_lr": HyperparameterConfig(
            value=0.001,
            kind="learning_rate",
            count=1,
            hyperparameter_parametrization=HyperparameterConfig.identity(),
        ...
        "level1_sgd_wd": HyperparameterConfig(
            value=0.0,
            kind="weight_decay",
            count=1,
            hyperparameter_parametrization=HyperparameterConfig.identity(),
        ...
        "level1_sgd_momentum": HyperparameterConfig(
            value=0.0,
            kind="momentum",
            count=1,
            hyperparameter_parametrization=HyperparameterConfig.identity(),
        ...
        "level2_beta": HyperparameterConfig(
            value=0.0,
            kind="kl_regularizer_beta",
            count=1,
            hyperparameter_parametrization=HyperparameterConfig.identity(),
    ...
    levels=[
        MetaConfig(
            ...
            dataset=DatasetConfig(num_examples_in_minibatch=128, num_examples_total=50_000, is_test=False),
            validation=StepConfig(num_steps=1, batch=1, reset_t=1, track_influence_in=frozenset({0})),
            nested=StepConfig(num_steps=1, batch=1, reset_t=None, track_influence_in=frozenset({0})),
            learner=LearnConfig(
                model_learner=GradientConfig(method=BPTTConfig(None), add_clip=HardClip(1.0), scale=1.0),
                optimizer_learner=GradientConfig(method=BPTTConfig(None), add_clip=HardClip(1.0), scale=1.0),
                optimizer={
                    "level0_sgd": OptimizerAssignment(
                        target=frozenset({"encoder_hidden", "encoder_out", "decoder_hidden", "decoder_out"}),
                        optimizer=SGDConfig(
                            learning_rate="level0_sgd_lr",
                            weight_decay="level0_sgd_wd",
                            momentum="level0_sgd_momentum",
                        ),
                    ),
                },
            ),
        ...
        MetaConfig(
            ...
            dataset=DatasetConfig(num_examples_in_minibatch=128, num_examples_total=10_000, is_test=False),
            validation=StepConfig(num_steps=1, batch=1, reset_t=None, track_influence_in=frozenset({1})),
            nested=StepConfig(num_steps=1, batch=1, reset_t=None, track_influence_in=frozenset({1})),
            learner=LearnConfig(
                model_learner=GradientConfig(method=BPTTConfig(None), add_clip=HardClip(1.0), scale=1.0),
                optimizer_learner=GradientConfig(
                ...
                optimizer={
                    "level1_sgd": OptimizerAssignment(
                        target=frozenset({"meta1_beta"}),
                        optimizer=SGDConfig(
                            learning_rate="level1_sgd_lr",
                            weight_decay="level1_sgd_wd",
                            momentum="level1_sgd_momentum",
                        ),
                    ),
                },
            ),
