...
opt_task = Task.init(
    project_name="oho",
    task_name="Seed+ILR Sweep: Batch-100,Epochs-100,MNIST,RNN-128-128,SGD-EXP,BPTT-RTRL",
)
...
optimizer = HyperParameterOptimizer(
    ...
    hyper_parameters=[
        ...
        DiscreteParameterRange("config/learners/1/optimizer/learning_rate/value", values=[1e-2, 1e-3]),
